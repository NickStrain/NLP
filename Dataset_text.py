...
class Flickdataset(Dataset):
    def __init__(self,image_path,caption_path,transformer=None,fre_threshold=5):
...
root_dir = 'E:\image captioning\imageforcaption'
...
def main():
    ...
    dataloader = get_loader(
        root_dir, captions_dir, transform=transform
    )
